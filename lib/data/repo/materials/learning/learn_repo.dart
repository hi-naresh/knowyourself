...
//   }
//
//   List<ChapterModel> _getLearningMaterialsFromStorage() {
//     var materialsJsonString = _storage.read(_storageKey);
//     if (materialsJsonString != null) {
//       return (jsonDecode(materialsJsonString) as List)
//           .map((materialMap) => ChapterModel.fromMap(materialMap as Map<String, dynamic>))
//           .toList();
//     } else {
//       return [];
//     }
...
//         .map((chapter) => ChapterModel.fromMap(chapter as Map<String, dynamic>))
//         .where((chapter) => chapter.aspect.toString().split('.').last == aspect)
//         .toList();
//
//     _storage.write(_storageKey, jsonEncode(chaptersList.map((e) => e.toMap()).toList()));
//   }
//
//   Future<List<ChapterModel>> loadMaterialsForAspect(String aspect) async {
